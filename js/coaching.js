  ...
  var tips = [
    ...
    },
    {
      ...
      points: [
        ...
        "Fun comes first here. US youth coaching follows \"athletes first, winning second\" (the player's growth matters more than the result) and \"the game teaches the game\" (kids learn fastest by actually playing) — lots of small-sided games (mini 2v2 or 3v3 rallies instead of the full six) and ball contacts, where the Romanian school you grew up in usually leads with technique and disciplined repetition. Both work; this app leans games-first, so trust the play.",
        ...
        "Practice is game-like, not lines. Expect random, slightly messy, over-the-net reps with a real ball and a score, rather than long blocked drills (the same skill repeated over and over in isolation) and conditioning laps. Short lines, many balls, everyone busy.",
        ...
        "Rules can differ by league. US club (USA Volleyball) is basically FIVB (the international volleyball federation whose rules the world plays by), like home, but US high-school (NFHS — the body that writes US high-school sports rules) rules vary — substitution counts, when the libero can serve, let serves, and some net and line calls. Always confirm the net height and rules with your specific league.",
    ...
    },
    {
      ...
      points: [
        ...
        "Give parents a simple job: cheer effort, get players to practice on time, and reinforce a growth mindset at home — praising hard work and improvement rather than labelling kids as just \"talented\" or \"not.\"",
